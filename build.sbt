...
libraryDependencies += "org.apache.flink" % "flink-connector-kafka-base_2.11" % "1.2.0"
//libraryDependencies += "org.apache.flink" % "flink-connector-elasticsearch5_2.11" % "1.2.0"
